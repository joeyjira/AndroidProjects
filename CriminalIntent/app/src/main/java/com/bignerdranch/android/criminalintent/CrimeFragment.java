...
public class CrimeFragment extends Fragment {
    ...
    private static final String DIALOG_VIEW = "DialogImage";
...
//                startActivity(i);
        ...
        mPhotoView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.show(manager, DIALOG_VIEW);
            }
        });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_DATE || requestCode == REQUEST_TIME) {
            ...
            // Perform your query - the contact Uri is like a "where" clause
    ...
    private void updateDate() {
        CharSequence dateFormat = DateFormat.format("EEEE, MMMM d, yyyy", mCrime.getDate());
